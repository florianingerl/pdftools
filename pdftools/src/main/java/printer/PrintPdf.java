...
public class PrintPdf {
	...
	public static void main(String[] args) throws IOException, PrinterException {
		System.out.println("Please enter the directory in which you want to print all pdf files:");
	...
	private static void printDir(File dir) throws IOException, PrinterException {
	...
	private static void printFile(File f) throws IOException, PrinterException {
